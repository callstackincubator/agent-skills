...
Package a bare React Native app into an Android AAR and publish it locally for deterministic native consumption.
...
- Building an Android-consumable artifact from bare React Native for brownfield integration
- Publishing local Maven artifacts for host app testing for bare RN
- Rebuilding AAR after React Native or native dependency changes for bare RN

## Prerequisites

- `bare-quick-start` baseline completed successfully
